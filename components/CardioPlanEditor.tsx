...
import {
  ...
  CARDIO_OBJECTIVES,
  cardioPerDistanceUnitLabel,
  durationUnitAbbreviation,
  type CardioDistanceTracking,
  type CardioDurationTracking,
  type CardioObjective,
} from '@/lib/cardioPlan';
import { CARDIO_DURATION_UNITS, usesIntegerDurationInput, type DurationUnit } from '@/lib/durationUnits';
...
export function CardioPlanEditor({
  ...
  const showDurationFields =
    objective === 'distance' && (durationTracking === 'total' || durationTracking === 'per_distance_unit');
  const showDistanceFields =
    objective === 'duration' && (distanceTracking === 'total' || distanceTracking === 'per_duration_unit');
          ...
          <View style={styles.metricRow} lightColor="transparent" darkColor="transparent">
            ...
            <RNView style={styles.metricInputs}>
              <TextInput
                ...
                keyboardType={usesIntegerDistanceInput(distanceUnit) ? 'number-pad' : 'decimal-pad'}
            ...
            <View style={styles.metricRow} lightColor="transparent" darkColor="transparent">
              ...
              <RNView style={styles.metricInputs}>
                <TextInput
                  ...
                  keyboardType={usesIntegerDurationInput(durationUnit) ? 'number-pad' : 'decimal-pad'}
                  placeholderTextColor={placeholderColor}
                  editable={!disabled}
                  style={inputStyle}
                />
                <DurationUnitPicker
                  ...
                  textColor={textColor}
                />
                {durationTracking === 'per_distance_unit' ? (
                  <Text style={[styles.perSuffix, { color: textColor }]}>
                    Per {cardioPerDistanceUnitLabel(distanceUnit)}
                  </Text>
                ) : null}
              </RNView>
            </View>
            ...
            <View style={styles.metricRow} lightColor="transparent" darkColor="transparent">
              ...
              <RNView style={styles.metricInputs}>
                ...
                <CardioDistanceUnitPicker
                  ...
                  textColor={textColor}
                />
                {distanceTracking === 'per_duration_unit' ? (
                  <Text style={[styles.perSuffix, { color: textColor }]}>
                    Per {durationUnitAbbreviation(durationUnit)}
                  </Text>
                ) : null}
              </RNView>
            </View>
