...
export function DurationUnitPicker({ value, onChange, disabled = false, borderColor, textColor }: Props) {
  ...
  return (
    <>
      <Pressable
        ...
        accessibilityLabel={`Time unit: ${DURATION_UNIT_LABELS[value]}. Tap to change.`}
        disabled={disabled}
      ...
      <Modal visible={open} transparent animationType="fade" onRequestClose={() => setOpen(false)}>
        <Pressable style={styles.backdrop} onPress={() => setOpen(false)}>
          <Pressable
            ...
            <Text style={[styles.sheetTitle, { color: textColor }]}>Time unit</Text>
